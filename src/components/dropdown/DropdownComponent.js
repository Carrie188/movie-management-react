...
DropdownComponent.propTypes = {
    ...
    options: arrayOf(
        shape({
            label: oneOfType([string, arrayOf(element)]), //PropTypes.element: The prop should be a React element 
            onClick: func
        })
    ),
    position: shape({
        ...
        bottom: number,
        left: number
    })// PropTypes.shape is for an object with values of the specified types
};
